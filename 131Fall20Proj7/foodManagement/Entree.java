...
/**
 * An IMMUTABLE class that represents a list of food and a name. For example, a
 * typical entree might be called "Big Bubba Breakfast" and might consist of the
 * list: 2 Egg, 3 Waffle, 1 Bacon, 1 Coffee
 */
public class Entree implements Listable {
	 ...
	 */
	private String name;
	private SortedListOfImmutables foodList; // This list will contain Food
												// objects
